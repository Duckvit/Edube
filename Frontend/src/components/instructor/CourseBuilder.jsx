...
import { Card, Button, Collapse, Form, Input, Modal, Space, Tag, Empty, message, Upload, InputNumber } from 'antd';
import {
  PlusOutlined,
  EditOutlined,
  DeleteOutlined,
...
const CourseBuilder = () => {
  ...
  const handleDeleteSection = (sectionId) => {
    Modal.confirm({
      ...
      content: 'Are you sure you want to delete this section and all its videos?',
      okText: 'Delete',
      okType: 'danger',
      onOk: () => {
  ...
  const handleSaveVideo = async (values) => {
    try {
      ...
      message.success(editingVideo ? 'Video updated successfully' : 'Video added successfully');
  ...
  const handlePublishCourse = () => {
    Modal.confirm({
      ...
      content: 'Are you sure you want to publish this course? Students will be able to enroll.',
      okText: 'Publish',
      onOk: () => {
  ...
  const totalDuration = sections.reduce((sum, s) =>
    sum + s.videos.reduce((vSum, v) => vSum + v.duration, 0), 0
  );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Build your course curriculum by adding sections and videos</p>
          </div>
          <Button
            type="primary"
            icon={<PlusOutlined />}
        ...
        {sections.length === 0 ? (
          <Card>
            <Empty
              description={
                <div>
                  <p className="text-gray-600 mb-4">No sections yet. Start building your course!</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          {section.videos.length} videos • {getTotalDuration(section.videos)}
                        </div>
                      </div>
                    </div>
      ...
      >
        ...
        >
          ...
          >
            <Input placeholder="e.g., Introduction to Components" size="large" />
          </Form.Item>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-4">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-blue-900">
                <strong>Upload Video:</strong> For now, upload your videos to YouTube, Vimeo, or cloud storage, then paste the URL here.
